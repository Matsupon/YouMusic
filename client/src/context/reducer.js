...
const reducer = (state, action) => {
  ...
  switch (action.type) {
    ...
    (data) =>
      data.artist.toLowerCase().includes(action.searchTerm) ||
      data.language.toLowerCase().includes(action.searchTerm) ||
      data.name.toLowerCase().includes(action.searchTerm) ||
      data.category.toLowerCase().includes(action.searchTerm)
    );
    return {
      ...state,
