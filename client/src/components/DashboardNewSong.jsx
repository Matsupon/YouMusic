...
export const ImageLoader = ({ progress }) => {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center">
      ...
      <div className="w-20 h-20 min-w-[40px] bg-ioAdd  animate-ping  rounded-full flex items-center justify-center relative">
        <div className="absolute inset-0 rounded-full bg-ioAdd  blur-xl "></div>
      </div>
    </div>
  );
};
          ...
          <div className="flex items-center justify-between gap-2 w-full flex-wrap">
            ...
            <div className="flex items-center justify-end w-full p-4">
              {isImageLoading || isAudioLoading ? (
                ...
                <motion.button
                  whileTap={{ scale: 0.75 }}
                  className="px-8 py-2 rounded-md text-white bg-ioAdd hover:shadow-lg"
                  onClick={saveSong}
                >
                  Send
                </motion.button>
