...
const MusicPlayer = () => {
  ...
  return (
    ...
    style={{ backgroundColor: '#15182bcc' }}>
      <div
      ...
      >
        ...
        <div className="h-full flex items-center justify-center flex-col gap-3">
          ...
          <motion.i whileTap={{ scale: 0.8 }} onClick={togglePlayer}>
            <IoArrowRedo style={{ color: '#c9448d' }} className="text-textColor hover:text-headingColor text-2xl cursor-pointer" />
          </motion.i>
        </div>
      </div>
      ...
      {miniPlayer && (
        ...
        >
          <div className="w-40 h-40 rounded-full flex items-center justify-center  relative ">
            <div className="absolute inset-0 rounded-full bg-ioAdd blur-xl animate-pulse"></div>
            <img
